...
rho = 1.000; % Density (kg/m^3) @ ~2500 ft ASL

%% Container
m = .6; % Mass (kg)
CDp = 1.0; % Coefficient of Drag of Parachute
A_p = linspace(0,.1); % Area of Parachute (m^2) (0.02 yields 19.7833)
...
m = .45; % Mass (kg)
CDp = 1.0; % Coefficient of Drag of Parachute
A_p = linspace(0,1); % Area of Parachute (m^2) (0.1 yields 9.3939)
